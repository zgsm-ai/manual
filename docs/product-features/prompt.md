...
- **Reduced Ambiguity:** Enhance Prompt helps to eliminate ambiguity and ensure that CoStrict understands your intent.
...
This page explains the technical structure of prompts in CoStrict - how messages are constructed and sent to the Large Language Model (LLM).
...
- **Environment Details:** Automatically appended information about your workspace state:Open files/tabs
...
1.  **Analyze:** Ask CoStrict to analyze the current code, identify problems, or plan the approach.
...
By following these tips, you can write effective prompts that get the most out of CoStrict's capabilities.
