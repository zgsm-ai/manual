...
To regulate the purchase and use of CoStrict AI programming services and protect the legitimate rights and interests of both users and Sangfor, these purchase terms are hereby established. Please read these terms carefully before making a purchase.

## 1. Product Plans and Pricing

### 1.1 Plan Types

CoStrict currently offers the following Credits packages:
...
Sangfor reserves the right to adjust product prices. Price adjustments will be simultaneously announced on the CoStrict official website. Credits already purchased will not be affected by price adjustments.

## 2. Purchase and Delivery

### 2.1 Purchase Channels

Users purchase CoStrict Credits packages through the CoStrict official website pricing page.

### 2.2 Credits Arrival Time
...
- Users can apply for invoice issuance in the CoStrict Management Platform page - [Subscription] - [Activation Records] - [Actions] - [Go to Invoice]
- Fill in the corresponding invoice information and submit the application
...
### 5.1 Service Adjustments

- Sangfor reserves the right to adjust service content, features, etc.
- Major adjustments will be announced 30 days in advance on the official website page
...
- Modified terms will be simultaneously announced on the CoStrict official website
- Continued purchase and use of services constitutes acceptance of the modified terms

## 9. Other

### 9.1 Terms Effectiveness

- These terms, together with the "CoStrict Fee Details," "CoStrict Service Level Agreement" constitute a complete service terms system
- In case of conflicts, specific terms shall prevail

### 9.2 Scope of Application

This terms only apply to CoStrict Credits packages purchased through the CoStrict payment page.
